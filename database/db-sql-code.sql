...
(
    ...
    CONSTRAINT review_inventory_fk FOREIGN KEY (inv_id)
        REFERENCES public.inventory (inv_id) MATCH SIMPLE
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT review_account_fk FOREIGN KEY (account_id)
...
CREATE INDEX IF NOT EXISTS review_inv_id_idx
    ON public.review (inv_id);
...
UPDATE public.inventory
SET inv_image = REPLACE(inv_image, '/images/vehicles/', '/images/vehicles/vehicles/'),
	inv_thumbnail = REPLACE(inv_thumbnail, '/images/vehicles/', '/images/vehicles/vehicles');
